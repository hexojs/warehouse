...
var _a = require('./util'), parseArgs = _a.parseArgs, shuffle = _a.shuffle;
var Query = /** @class */ (function () {
    ...
    Query.prototype.find = function (query, options) {
        ...
        var _a = this, data = _a.data, length = _a.length;
        var _b = options.lean, lean = _b === void 0 ? false : _b;
        var _c = options.limit, limit = _c === void 0 ? length : _c, skip = options.skip;
        var arr = [];
    ...
    Query.prototype.update = function (data, callback) {
        ...
        return Promise.mapSeries(this.data, function (item) { return model._updateWithStack(item._id, stack); }).asCallback(callback);
    };
    /**
    ...
    Query.prototype.replace = function (data, callback) {
        var model = this._model;
        return Promise.map(this.data, function (item) { return model.replaceById(item._id, data); }).asCallback(callback);
    };
    /**
    ...
    Query.prototype.remove = function (callback) {
        var model = this._model;
        return Promise.mapSeries(this.data, function (item) { return model.removeById(item._id); }).asCallback(callback);
    };
    /**
