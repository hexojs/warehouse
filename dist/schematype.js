'use strict';
var setProp = require('./util').setProp;
...
var SchemaType = /** @class */ (function () {
    ...
    function SchemaType(name, options) {
        ...
        if (typeof default_ === 'function') {
            ...
            this.default = function () { return default_; };
        }
    }
    /**
     ...
     * @return {*}
     */
    SchemaType.prototype.u$unset = function (value, update, data) { return update ? undefined : value; };
    /**
     * Renames a field.
     *
     * @param {*} value
